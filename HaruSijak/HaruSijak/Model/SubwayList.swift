...
//---------------1번쨰 방법---------------
// 형은 if로 처리해서 강남이 똑같은 좌표로 처리해서
//버튼을 눌렀을때 역의 값,호선값은 있어 -> 역 값으로 리스트에서 다시 찾아 -> 호선값이 다른 값을 가져와 -> 만약에 다른값이 두개면 세그먼트 두개 생성하고 버튼 눌렀을때 그 값으로 다시 서버에 요청을 해
//---------------2번쨰 방법---------------
//("강남", 200.0, 200.0, 2, 3, 5, 0, 0),
//("강남", 200.0, 200.0, 2, 0, 0),
//이렇게 데이터를 만들어서 0, 0 이 값을 기준으로 세그먼트 조정



struct  SubwayList{
    let testStation = [
        ("종로3가", 200.0, 200.0, 1, 3, 5),
...
//        ("연신내", 1160.0, 2420.0, 3, 0, 0),
//        ("불광", 1164.0, 2601.0, 3, 0, 0),
...
//        ("종로3가", 2052.0, 3453.0, 3, 0, 0),
//        ("을지로3가", 2237.0, 3527.0, 3, 0, 0),
//        ("충무로", 2378.0, 3594.0, 3, 0, 0),
//        ("동대입구", 2454.0, 3635.0, 3, 0, 0),
//        ("약수", 2577.0, 3684.0, 3, 0, 0),
//        ("금호", 2683.0, 3736.0, 3, 0, 0),
//        ("옥수", 2803.0, 3783.0, 3, 0, 0),
//        ("압구정", 2857.0, 3815.0, 3, 0, 0),
//        ("신사", 2942.0, 3843.0, 3, 0, 0),
//        ("잠원", 3008.0, 3883.0, 3, 0, 0),
//        ("고속터미널", 3106.0, 3929.0, 3, 0, 0),
//        ("교대", 3380.0, 4046.0, 3, 0, 0),
...
//        ("강남", 3312.0, 5384.0, 2, 1),  => 이상치
        ...
        ("가락시장", 3309.0, 4940.0, 3, 0, 0),
        ("경찰병원", 3309.0, 5134.0, 3, 0, 0),
        ("오금", 3312.0, 5384.0, 3, 0, 0),
        ...
        ("사당", 3581.0, 3354.0, 4, 0, 0),
        ("총신대입구", 3292.0, 3483.0, 4, 0, 0),
        ("동작", 3105.0, 3573.0, 4, 0, 0),
        ("이촌", 2925.0, 3508.0, 4, 0, 0),
        ("신용산", 2762.0, 3437.0, 4, 0, 0),
        ("삼각지", 2595.0, 3363.0, 4, 0, 0),
        ("숙대입구", 2506.0, 3320.0, 4, 0, 0),
        ("서울역", 2411.0, 3299.0, 4, 0, 0),
        ("회현", 2411.0, 3393.0, 4, 0, 0),
        ("명동", 2411.0, 3502.0, 4, 0, 0),
        ("충무로", 2377.0, 3594.0, 4, 0, 0),
        ("동대문역사문화공원", 2224.0, 3673.0, 4, 0, 0),
        ("동대문", 1877.0, 3819.0, 4, 0, 0),
        ...
        ("군자", 2225.0, 4333.0, 7, 0, 0),
        ("어린이대공원", 2338.0, 4282.0, 7, 0, 0),
        ("건대입구", 2413.0, 4251.0, 7, 0, 0),
        ...
        ("고속터미널", 3107.0, 3932.0, 7, 0, 0),
        ("내방", 3283.0, 3671.0, 7, 0, 0),
        ("이수", 3290.0, 3480.0, 7, 0, 0),
